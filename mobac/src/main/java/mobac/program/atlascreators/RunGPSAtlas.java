 ...
 *
 * <p>
 * Run.GPS Atlas format has been designed to support huge collections of maps (2
 * GB and more) and for very fast access (using a numeric index at the beginning
 * of an atlas file). The file format can hold integer values, strings and
 * binary data. The file format is described on this page:
 * http://www.rungps.net/wiki/RunGPSAtlasFormat (full sample source code is
 * available).
 * </p>
 */
