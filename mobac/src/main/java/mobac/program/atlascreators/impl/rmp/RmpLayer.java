...
public class RmpLayer {
	...
	private TileContainer buildTileTree() {
		...
		/*
		 * --- Calculate the number of tiles and tiles per container. 99 would be
		 * possible but we limit ourselves to 80 - That's enough ---
		 */
	 ...
	 * @throws IOException
	 */
	public void buildTLMFile(double tile_width, double tile_height, double left, double right, double top,
