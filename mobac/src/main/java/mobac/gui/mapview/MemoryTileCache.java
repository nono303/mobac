...
/**
 * Cache that stores all {@link Tile} objects in memory up to a certain limit (
 * {@link #getCacheSize()}). If the limit is exceeded the least recently used
 * {@link Tile} objects will be deleted.
 *
...
public class MemoryTileCache implements NotificationListener {
	...
	/**
	 * Linked list element holding the {@link Tile} and links to the {@link #next}
	 ...
	 * elements. It supports element removal in constant time - in difference to the
	 * Java implementation which needs O(n).
	 *
	 * @author Jan Peter Stotz
	 */
